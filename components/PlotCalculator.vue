<template>
  <div>
    ...
    <h3>График зависимости угла внутреннего трения от удельного сцепления при внецентренном нагружении</h3>
    <h4>Ось "Y" - Fпр,кН, Ось "X" - c,кН/м^2</h4>
    <calc-plot-fi :height="400" :data="results"></calc-plot-fi>
  </div>
</template>
