<template>
  <div>
    <div>
      ...
      <div>
        В данном разделе определяется предельная нагрузка, приложенная к оголовку сооружения, которую сооружение воспринимает без потери несущей способности основания.<br>
        Для того, чтобы определить предельную нагрузку задайтесь основными размерами оболочки (наружный диаметр –D, толщина стенки – t, высота конструкции – h , плечо равнодействующей нагрузки – d) , а также физико-механическими характеристиками грунта основания (угол внутреннего трения – φ, удельное сцепление – с).<br>
        Промежуточные значения могут быть определены интерполяцией.<br>
      </div><br>
